...
import finatra.travel.site.App
...
trait ProfileService {
  val profileService = {
    ...
    new finatra.travel.site.services.ProfileService(profileHost(), profileUrl())
  }
}
...
trait LoyaltyService {
  val loyaltyService = {
    ...
    new finatra.travel.site.services.LoyaltyService(loyaltyHost(), loyaltyUrl())
  }
}
...
trait OffersService {
  val offersService = {
    ...
    new finatra.travel.site.services.OffersService(offersHost(), offersUrl())
  }
}
...
trait UserService {
  val userService = {
    ...
    new finatra.travel.site.services.UserService(userHost(), userUrl())
  }
}
...
trait LoginService {
  val loginService = {
    ...
    new finatra.travel.site.services.LoginService(loginHost(), loginUrl())
  }
}
...
trait AdvertService {
  val advertService = {
    ...
    new finatra.travel.site.services.AdvertService(host(), url())
  }
}
